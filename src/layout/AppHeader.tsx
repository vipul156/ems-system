          ...
          <div className="flex items-center gap-2 2xsm:gap-3">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none rounded-lg border border-gray-200 bg-white py-2 pl-3 pr-8 text-sm font-medium text-gray-700 focus:outline-none dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400"
              >
